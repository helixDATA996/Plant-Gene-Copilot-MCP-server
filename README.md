...
##High-level flow:
MCP Frontend (this repo)
MCP Server endpoints (tool definitions)
Intermediary API service (query optimization + data integrity)
MySQL knowledge bases + external sources integrations
